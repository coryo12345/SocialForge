...
const DEFAULTS: Record<string, string> = {
  ...
  activity_feed_lookback_days: '7',
  llm_temperature: '1.0',
  post_ideation_temperature: '1.1',
  post_writing_temperature: '1.0',
  post_title_temperature: '1.0',
  ...
  markdown_render_posts: 'true',
  markdown_render_comments: 'true',
  show_ai_persona_on_profile: 'true',
};
